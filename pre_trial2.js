...
let expName = 'pre_trial2';  // from the Builder filename that created this script
let expInfo = {
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'conditions_pretrial2.xlsx', 'path': 'conditions_pretrial2.xlsx'},
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: 'conditions_pretrial2.xlsx',
