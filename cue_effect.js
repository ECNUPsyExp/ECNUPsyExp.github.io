...
function trialRoutineEachFrame() {
  return async function () {
    ...
    frameRemains = 1.5 + 0.4 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    ...
    frameRemains = 1.9 + 0.4 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
